...
public class UserForm extends FormLayout {
    ...
    public UserForm() {
        ...
        email.setLabel(getTranslation("auth.email"));
        fullName.setLabel(getTranslation("auth.fullname"));
        phone.setLabel(getTranslation("auth.phone"));
        password.setLabel(getTranslation("auth.password"));
        role.setLabel(getTranslation("form.user.role"));
    ...
    public static abstract class UserFormEvent extends ComponentEvent<UserForm> {
        private final User user;
        protected UserFormEvent(UserForm source, User user) { super(source, false); this.user = user; }
        public User getUser() { return user; }
    }
    public static class SaveEvent extends UserFormEvent {
        private final String rawPassword;
        SaveEvent(UserForm source, User user, String rawPassword) { super(source, user); this.rawPassword = rawPassword; }
        public String getRawPassword() { return rawPassword; }
    }
    public static class DeleteEvent extends UserFormEvent { DeleteEvent(UserForm source, User user) { super(source, user); } }
    public static class CloseEvent extends UserFormEvent { CloseEvent(UserForm source) { super(source, null); } }
