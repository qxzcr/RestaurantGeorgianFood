...
public class ReservationForm extends FormLayout {
    ...
    DatePicker reservationDate = new DatePicker();
    TimePicker reservationTime = new TimePicker();
    IntegerField guestCount = new IntegerField();
    ...
    public ReservationForm(List<User> allUsers) {
        ...
        title.setText(getTranslation("btn.edit"));
        user.setLabel(getTranslation("res.customer"));
        phone.setLabel(getTranslation("auth.phone"));
        reservationDate.setLabel(getTranslation("res.date"));
        reservationTime.setLabel(getTranslation("res.time"));
        guestCount.setLabel(getTranslation("res.guests"));

        save.setText(getTranslation("btn.save"));
        delete.setText(getTranslation("btn.delete"));
        close.setText(getTranslation("btn.cancel"));
    ...
    public static abstract class ReservationFormEvent extends ComponentEvent<ReservationForm> {
        private final Reservation reservation;
        protected ReservationFormEvent(ReservationForm source, Reservation reservation) { super(source, false); this.reservation = reservation; }
        public Reservation getReservation() { return reservation; }
    }
    public static class SaveEvent extends ReservationFormEvent { SaveEvent(ReservationForm source, Reservation reservation) { super(source, reservation); } }
    public static class DeleteEvent extends ReservationFormEvent { DeleteEvent(ReservationForm source, Reservation reservation) { super(source, reservation); } }
    public static class CloseEvent extends ReservationFormEvent { CloseEvent(ReservationForm source) { super(source, null); } }
